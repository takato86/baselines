...
from baselines.her_rs.replay_buffer import ReplayBuffer
...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        Args:
            ...
            network_class (str): the network class that should be used (e.g. 'baselines.her_rs.ActorCritic')
        ...
        buffer_shapes['rs'] = (self.T-1, 1)  # Okudo adds
