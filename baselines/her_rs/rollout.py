...
class RolloutWorker:
    ...
    def __init__(self, venv, policy, dims, logger, T, rollout_batch_size=1,
                 ...
                 random_eps=0, history_len=100, render=False, monitor=False, reward_shaping=None, **kwargs):
    ...
    def generate_rollouts(self):
        ...
        # generate episodes
        obs, achieved_goals, acts, goals, successes, shaping_reward = [], [], [], [], [], []
        dones = []
        ...
        for t in range(self.T):
            ...
            obs_dict_new, r, done, info = self.venv.step(u)
